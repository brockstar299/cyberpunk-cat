...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cyberpunk-cat
```

A live public deployment of this template is available at [https://cyberpunk-cat.templates.workers.dev](https://cyberpunk-cat.templates.workers.dev)
